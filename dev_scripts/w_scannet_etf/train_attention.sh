...
train_and_test=0 #1
test_num=10
test_freq=500 #  #100 #1200 #1200 #30184 #30184 #50000
print_freq=40
test_num_step=1000
...
color_loss_items='ray_masked_coarse_raycolor '
#color_loss_weights="1.0 1.0 1.0 "
#color_loss_items='loss_rgb loss_opacity ray_masked_coarse_raycolor '
