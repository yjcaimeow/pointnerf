...
from .neural_points_volumetric_multi_model import NeuralPointsVolumetricMultiModel
...
class MvsPointsVolumetricMultiModel(NeuralPointsVolumetricMultiModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        NeuralPointsVolumetricMultiModel.modify_commandline_options(parser, is_train=is_train)
        parser.add_argument(
            '--mode',
            type=int,
            default=2,
    ...
    def create_network_models(self, opt):
        ...
        if opt.mode != 1:
            super(MvsPointsVolumetricMultiModel, self).create_network_models(opt)
    ...
    def setup(self, opt, train_len=None):
        super(MvsPointsVolumetricMultiModel, self).setup(opt)
