...
from .neural_points_volumetric_multi64_model import NeuralPointsVolumetricMulti64Model
...
class MvsPointsVolumetricMulti64Model(NeuralPointsVolumetricMulti64Model):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        NeuralPointsVolumetricMulti64Model.modify_commandline_options(parser, is_train=is_train)
        parser.add_argument(
            '--mode',
            type=int,
            default=2,
    ...
    def create_network_models(self, opt):
        ...
        if opt.mode != 1:
            super(MvsPointsVolumetricMulti64Model, self).create_network_models(opt)
    ...
    def setup(self, opt, train_len=None):
        super(MvsPointsVolumetricMulti64Model, self).setup(opt)
