...
class Engine(object):
    def __init__(self, custom_parser=None, args=None):
        self.devices = None
        ...
        if self.distributed:
            ...
            print (self.local_rank, local_rank, 'local_rank')
            self.world_size = int(os.environ['WORLD_SIZE'])
            torch.cuda.set_device(self.local_rank)
            #os.environ['MASTER_PORT'] = self.args.port
            #dist.init_process_group(backend="gloo", world_size=self.world_size, init_method='env://')
